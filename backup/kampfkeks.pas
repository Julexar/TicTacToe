        ...
        begin
             for j:=1 to 3 do
                 ...
                 //Überprüfe ob Bot gewinnen kann.
                     ...
                     //for a:=1 to 3 do
                         //begin
                              //if (Form1.getBelegung(a,1)=Form1.getBelegung(a,2)) AND NOT (Form1.getBelegung(a,1)=botNr) XOR (Form1.getBelegung(a,1)=Form1.getBelegung(a,3)) AND NOT (Form1.getBelegung(a,1)=botNr) XOR (Form1.getBelegung(a,2)=Form1.getBelegung(a,3)) AND NOT (Form1.getBelegung(a,2)=botNr) then         //Zeilen durchsuchen
                                 //begin
                                      //for b:=1 to 3 do
                                          //begin
                                               //if (Form1.getBelegung(a,b)=0) then
                                           ...
                                           //end
                                  //end;
                               //if (Form1.getBelegung(1,a)=Form1.getBelegung(2,a)) AND NOT (Form1.getBelegung(1,a)=botNr) XOR (Form1.getBelegung(1,a)=Form1.getBelegung(3,a)) AND NOT (Form1.getBelegung(1,a)=botNr) XOR (Form1.getBelegung(2,a)=Form1.getBelegung(3,a)) AND NOT (Form1.getBelegung(2,a)=botNr) then
                                  //begin
                                       //for b:=1 to 3 do
                                           //begin
                                                //if (Form1.getBelegung(b,a)=0) then
