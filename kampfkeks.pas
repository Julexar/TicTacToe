        ...
        begin
             for j:=1 to 3 do
                 ...
                 //Überprüfe ob Bot gewinnen kann.
                     ...
                     for a:=1 to 3 do
                         begin
                              if ((Form1.getBelegung(a,1)=Form1.getBelegung(a,2)) AND NOT (Form1.getBelegung(a,1)=botNr) AND (Form1.getBelegung(a,1)>0)) XOR ((Form1.getBelegung(a,1)=Form1.getBelegung(a,3)) AND NOT (Form1.getBelegung(a,1)=botNr) AND (Form1.getBelegung(a,1)>0)) XOR ((Form1.getBelegung(a,2)=Form1.getBelegung(a,3)) AND NOT (Form1.getBelegung(a,2)=botNr) AND (Form1.getBelegung(a,2)>0)) then         //Zeilen durchsuchen
                                 begin
                                      for b:=1 to 3 do
                                          begin
                                               if (Form1.getBelegung(a,b)=0) then                      //Zeilen
                                                   begin
                                                        Form1.zug(a,b);
                                                        exit;
                                                   end
